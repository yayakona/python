...
def load_data(stock_id, start="0000-00-00", end="9999-99-99", should_all_update=False, should__diff_update=False):
    ...
    with closing(sqlite3.connect(dbname)) as conn:
        ...
        updated_date = conn.executor(sqls.last_modified_sql, (stock_id))
        ...
        if all_update_flag:
            ...
            conn.executor(sqls.delete_m_stock_info, (stock_id))
            conn.executor(sqls.insert_m_stock_info, (stock_id, "sample", now_date))
            conn.commit()
